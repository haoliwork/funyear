...
import { FOOTER_COPYRIGHT, FOOTER_CONTACT, BRAND_RED, ACCENT_GOLD, TEXT_LIGHT, PRIMARY_BG, TEXT_SECONDARY, BORDER_COLOR } from '../constants'; // 引入新的顏色常量

const Footer: React.FC = () => {
  return (
    // 頁腳背景色調整
    <footer className={`bg-primary-bg py-12 mt-16 text-text-secondary`}>
      <div className="container mx-auto max-w-7xl px-4 text-center md:text-left">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-text-secondary text-sm">您的企業年度盛會策劃專家。</p>
          </div>

          <div className="flex flex-col items-center md:items-center">
            <h4 className="text-lg font-semibold text-text-light mb-4">聯絡我們</h4> {/* 標題顏色調整 */}
          ...
          <div className="flex flex-col items-center md:items-end">
            <h4 className="text-lg font-semibold text-text-light mb-4">追蹤我們</h4> {/* 標題顏色調整 */}
