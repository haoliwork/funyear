...
const CaseCard: React.FC<CaseCardProps> = ({ caseStudy }) => {
  return (
    ...
    <div className={`bg-card-bg border border-border-color rounded-2xl shadow-xl overflow-hidden 
      ...
      <div className="p-6"> {/* 內距調整 */}
        {/* 標題顏色與大小調整 */}
        <h3 className={`text-xl font-semibold text-accent-gold mb-3`}>{caseStudy.name}</h3> {/* 縮小標題 */}
        {/* 內文顏色調整 */}
        <p className={`text-sm text-text-secondary mb-2`}> {/* 縮小內文 */}
        ...
        <p className={`text-sm text-text-secondary`}> {/* 縮小內文 */}
